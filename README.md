...
Hello, I am Mohamed Gandoul,  I am a student currently studying for a two-year diploma in web development. in Information Technology at the Institute located in Morocco (ISTA, OFPPT). My ambition is to complete this degree as a technician specializing in software development and to be a (FULL-STACK DEVELOPER) At the same time I'm learning UI/UX DESIGN I hope to deepen a lot in this field because it is a field that I would very much like to complete.
